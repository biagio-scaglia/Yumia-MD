...
## Reusable Components & Dynamic Data-Binding
...
slide "Cluster {{region}}" each="regions"
  heading "Telemetry for {{region}}"
  grid columns=2 gap=20
    ResearchPill "Inference Latency", "Sub-millisecond reduction.", "{{latency}}", "success"
    ResearchPill "Throughput Rate", "Peak sustained operations.", "{{throughput}}", "accent"
```
