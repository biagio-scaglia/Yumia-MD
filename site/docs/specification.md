...
| :-------------- | :--------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------- | :----------------------------------------------------- |
| `:::hero`       | `:::hero title="..." [subtitle="..."] [badge="..."] [tagline="..."] [align="..."]` | `title`, `subtitle`, `badge`, `tagline`, `emphasis`, `align`, `density`              | PPTX, PDF, HTML                                        |
| `:::callout`    | `:::callout [variant="..."] [title="..."] [icon="..."] \n ... \n :::`              | `variant` (`info\|warning\|success\|danger\|accent`), `title`, `icon`, `collapsible` | PPTX, PDF, HTML                                        |
| `:::image`      | `:::image src="..." [alt="..."] [fit="..."] [radius="..."] [shadow="..."]`         | `src`, `alt`, `caption`, `fit`, `radius`, `shadow`, `aspectRatio`, `zoomable`        | PPTX (Bitmap), PDF (Bitmap fit), HTML (Image)          |
